...
crime.fit <- ergmm(crime_net ~ euclidean(d = 2, G = 3), verbose = TRUE)
...
network.vertex.names(crime_net)
...
crime.fit2 <- ergmm(crime_net ~ euclidean(d=2, G=0), tofit=c("mle"))
...
#  more printout.
crime.fit5 <- ergmm(crime_net ~ euclidean(d = 2, G = 5),
                      verbose = TRUE)
